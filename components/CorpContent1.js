              ...
              <div className="contentCanvas contentCanvas--card">
                  <div className="flipCardContainer" id="flipContainer1" onMouseEnter={this.flip1} onMouseLeave={this.unflip1}>
                    <div className={this.state.className1}  id="card1">
                        ...
                        style={{
                          backgroundImage: "url(" + `${require("../public/assets/CCON-7-loading-bay.jpg")}` + ")",
                          width: "100%",
                          height:"100%",
                        ...
                        <div className="card__face card__face--back" id={this.state.fadeOneB}>
                          ...
                          <p className="cardText" id="cardText1">Ccon Metals can act as a main receiving hub for multi-location clientele. This allows shipments from each location to be tracked, organized, graded, and invoiced; providing our clients peace of mind.</p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className={this.state.className2}  id="card2">
                        ...
                        style={{
                          backgroundImage: "url(" + `${require("../public/assets/CCON-8-invoice.jpeg")}` + ")",
                          width: "100%",
                          height:"100%",
                          backgroundRepeat: "no-repeat",
                          backgroundSize: "cover",
                        ...
                        <div className="card__face card__face--back" id={this.state.fadeTwoB}>
                          ...
                          <p className="cardText" id="cardText2">Ccon Metals is well versed in all aspects of multi layer accounts and their specific needs, either standard or customized. Call or email us today to find out how we can customize your Revolution experience!</p>
                        </div>
                      </div>
                    </div>
