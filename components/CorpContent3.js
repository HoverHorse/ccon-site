...
render() {
  ...
  return (
        <div id="contentContainer">
              ...
              <ul id="outer-list">
                    <li style={{ listStyle: "none" }}><strong><u>If I create an account, do my staff need to create their own accounts as well?</u></strong><br />
                    The primary account holder is responsible for sending any Ccon Revolution App invitations to their employees. This can be done via the “staff“ option, under the "management" heading, within the App.
                    </li>
